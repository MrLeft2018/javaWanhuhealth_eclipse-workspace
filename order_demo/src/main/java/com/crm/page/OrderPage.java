...
public class OrderPage {
	...
	public static WebElement newOrder_addClient(WebDriver driver){
		element = driver.findElement(By.cssSelector(".-x-id-search .ant-select-selection__placeholder"));
	...
	public static WebElement newOrder_addClient1(WebDriver driver){
		element = driver.findElement(By.cssSelector(".-x-id-search input"));
	...
	public static WebElement newOrder_addressee(WebDriver driver){
		element = driver.findElement(By.cssSelector(".-x-id-receiver .ant-select-selection__rendered"));
	...
	public static WebElement newOrder_medicine_AddMedicineToOrder_name(WebDriver driver){
		element = driver.findElement(By.cssSelector("input.-x-id-add_medicine"));
	...
	public static WebElement newOrder_buyNumber(WebDriver driver){
		element = driver.findElement(By.cssSelector(".-x-repeat-drugs.-x-index-0 .-x-id-amount .ant-input-number-input"));
	...
	public static WebElement newOrder_Hz(WebDriver driver){
		element = driver.findElement(By.cssSelector("-x-id-frequency .ant-select-selection-selected-value"));
		//element = driver.findElement(By.xpath(".//*[@id='addMedicineRegisterForm']/div[8]/div/div/div/ul/li[1]/div"));
		return element;
	}
	...
	public static WebElement newOrder_save(WebDriver driver){
		element = driver.findElement(By.cssSelector("button.-x-id-submit"));
